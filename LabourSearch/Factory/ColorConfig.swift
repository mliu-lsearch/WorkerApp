...
struct ColorConfig {
    ...
    static let startTimeLabelBackgroundColor = UIColor.clear
    static let startTimeLabelTextColor = UIColor.white
    ...
    //M: startTimeValue label
    static let startTimeValueBackgroundColor = UIColor.clear
    static let startTimeValueTextColor = UIColor(red: (255 / 255.0), green: (255 / 255.0), blue: (255 / 255.0), alpha: 0.5)
    
    //M: deductionsValue label
    static let endTimeValueBackgroundColor = UIColor.clear
    static let endTimeValueTextColor = UIColor(red: (255 / 255.0), green: (255 / 255.0), blue: (255 / 255.0), alpha: 0.5)
